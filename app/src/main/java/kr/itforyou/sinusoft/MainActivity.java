...
public class MainActivity extends AppCompatActivity {
    LinearLayout webLayout,menu1Layout,menu2Layout,menu3Layout,menu4Layout,menu5Layout;
    ...
    public void setLayout() {
        ...
        menu1Layout=(LinearLayout)findViewById(R.id.menu1Layout);
        menu2Layout=(LinearLayout)findViewById(R.id.menu2Layout);
        menu3Layout=(LinearLayout)findViewById(R.id.menu3Layout);
        menu4Layout=(LinearLayout)findViewById(R.id.menu4Layout);
        menu5Layout=(LinearLayout)findViewById(R.id.menu5Layout);
        menu1Layout.setOnClickListener(mOnClickListener);
        menu2Layout.setOnClickListener(mOnClickListener);
        menu3Layout.setOnClickListener(mOnClickListener);
        menu4Layout.setOnClickListener(mOnClickListener);
        menu5Layout.setOnClickListener(mOnClickListener);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.menu2Layout:
                    Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse(getString(R.string.tel)));
                    startActivity(intent);
                    break;
                case R.id.menu3Layout:
                    webView.loadUrl(getString(R.string.place));
                    break;
                case R.id.menu4Layout:
                    Intent sharedIntent = new Intent();
                    sharedIntent.setAction(Intent.ACTION_SEND);
                    sharedIntent.setType("text/plain");
                    sharedIntent.putExtra(Intent.EXTRA_SUBJECT, "육임신문");
                    sharedIntent.putExtra(Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=kr.itforyou.yism");
                    Intent chooser = Intent.createChooser(sharedIntent, "공유");

                    startActivity(chooser);
                    break;
                case R.id.menu5Layout:
                    finish();
                    break;
            }
        }
